        ...
        <AnimatedSection id="contact">
            <div className="container mx-auto px-4">
                ...
                <div className="grid grid-cols-1 gap-10 lg:grid-cols-3">
                    <div className="lg:col-span-2">
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        ...
                                        className="border-purple-200 focus:border-purple-400 dark:border-purple-700/20 dark:focus:border-purple-500"
                                    />
                                </div>
                                <div className="space-y-2">
                                    <label
                            ...
                            <Button
                                type="submit"
                                disabled={loading}
                                className="bg-purple-gradient w-full px-8 text-white hover:opacity-90 sm:w-auto"
                            >
                                {loading ? (
                                    <>Enviando...</>
                                ) : (
                    ...
                    <div className="h-fit rounded-xl border border-purple-100 bg-white p-6 shadow-md dark:border-purple-700/20 dark:bg-purple-800/10">
                        ...
                        <div className="space-y-6">
                            {contactInfo.map((item, index) => (
                                <a
                                    key={index}
                                    href={item.link}
                                    className="text-foreground flex items-start gap-4 transition-colors hover:text-purple-600 dark:hover:text-purple-400"
                                >
                                    <div className="rounded-full bg-purple-100 p-3 dark:bg-purple-700/20">
                                        {item.icon}
                                    </div>
                                    <div>
                        ...
                        <div className="mt-8">
                            ...
                            <div className="flex space-x-4">
                                <a
                                    ...
                                    target="_blank"
                                    className="flex h-10 w-10 items-center justify-center rounded-full bg-purple-100 text-purple-600 transition-colors hover:bg-purple-200 dark:bg-purple-700/20 dark:text-purple-400 dark:hover:bg-purple-600/20"
                                >
                                    <Github />
                                </a>
                                <a
